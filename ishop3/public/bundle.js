...
var _ShopBlock = __webpack_require__(19);

var _ShopBlock2 = _interopRequireDefault(_ShopBlock);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var shopCatalog = __webpack_require__(25);

_reactDom2.default.render(_react2.default.createElement(_ShopBlock2.default, { catalog: shopCatalog }), document.getElementById('container'));
...
var _ItemBlock = __webpack_require__(24);
...
var ShopBlock = function (_React$Component) {
    _inherits(ShopBlock, _React$Component);
    ...
    function ShopBlock() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ShopBlock.__proto__ || Object.getPrototypeOf(ShopBlock)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            'selectedItems': []
        }, _this.deleteItemCallback = function (id) {
            _this.setState({ catalog: _this.state.catalog.filter(function (item) {
                    return item.id != id;
                }) });
        }, _this.selectItemCallback = function (itemId) {
            _this.setState({ selectedItems: [itemId] });
    ...
    _createClass(ShopBlock, [{
        ...
        value: function render() {
            ...
            var listItems = this.state.catalog.map(function (item) {
                return _react2.default.createElement(_ItemBlock2.default, {
                    key: item.id,
                    item: item,
                    selected: _this2.state.selectedItems.indexOf(item.id) > -1,
                    deleteCallback: _this2.deleteItemCallback,
                    selectItemCallback: _this2.selectItemCallback
                });
            });
...
ShopBlock.propTypes = {
    catalog: _propTypes2.default.arrayOf(_propTypes2.default.shape({
        ...
        leftInStock: _propTypes2.default.number.isRequired
    }))
};
exports.default = ShopBlock;
...
var ItemBlock = function (_React$Component) {
    ...
    function ItemBlock() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ItemBlock.__proto__ || Object.getPrototypeOf(ItemBlock)).call.apply(_ref, [this].concat(args))), _this), _this.deleteItem = function (event) {
            _this.props.deleteCallback(_this.props.item.id);
        }, _this.selectItem = function (event) {
            _this.props.selectItemCallback(_this.props.item.id);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(ItemBlock, [{
        key: "render",
        value: function render() {
            var url = this.props.item.url ? this.props.item.url : "http://up100.uppolice.gov.in/PublishingImages/No-Image-Basic.png";
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "td",
                    null,
                    _react2.default.createElement("input", { value: "delete", type: "button", onClick: this.deleteItem })
                )
            );
        }
    }]);
...
module.exports = [{"id":1,"name":"Виски Jameson 40% 0,5л","price":20,"url":"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS20SphwtkpZdvsQH8wdJsSbhm1oY0AiEJNB7ej6ngbrul6LkbQ","leftInStock":222},{"id":2,"name":"Виски William Lawsons 0,7 л","price":30,"url":"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeRN1HP59uVqMUj7KX_X54pKCrBkmhFhcHB_mp4HqaZaBEZnBn","leftInStock":555},{"id":3,"name":"Виски Jameson 40% 0,5л","price":40,"leftInStock":66},{"id":4,"name":"Виски William Lawson 0,7 л","price":50,"url":"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeRN1HP59uVqMUj7KX_X54pKCrBkmhFhcHB_mp4HqaZaBEZnBn","leftInStock":33}]
